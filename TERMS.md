...
These terms govern your use of MiruScriptX, an open-source programming language
and interpreter (the "Software"). By downloading, building, running, or
...
You are responsible for the programs you write and run with the Software.
MiruScriptX executes programs with the full permissions of the account running
it and does not sandbox them. Do not use the Software to build or run anything
unlawful, and do not run untrusted MiruScriptX programs expecting isolation.
...
"MiruScriptX" and the `miru` command name identify this project. You may refer
to the project by name, but please do not use the name in a way that implies
