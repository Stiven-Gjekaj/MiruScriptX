...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-486_passing-427819?style=for-the-badge" alt="486 tests passing"/>
</p>
...
| **Parser** | ast.rs, parser.rs | 1813 | Recursive descent plus a Pratt expression parser |
| **Runtime model** | value.rs, ops.rs, builtins.rs, random.rs | 4737 | Values, operator and indexing rules, the builtin library |
| **Bytecode engine** | chunk.rs, globals.rs, compiler.rs, vm.rs | 4488 | Compiles the AST to bytecode, runs it on a stack VM, loads modules, and catches errors |
| **Diagnostics** | suggest.rs | 220 | Chooses the name an error offers back when a program misspells one |
| **Formatter** | formatter.rs | 770 | Reprints a program in canonical form (`miru fmt`) |
...
| **Total** | **19 files** | **16287** | Written from scratch in Rust |
