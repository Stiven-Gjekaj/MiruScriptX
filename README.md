...
| **Runtime model** | value.rs, ops.rs, builtins.rs, random.rs | 4717 | Values, operator and indexing rules, the builtin library |
...
| **Total** | **19 files** | **16057** | Written from scratch in Rust |
