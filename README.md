...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-531_passing-427819?style=for-the-badge" alt="531 tests passing"/>
</p>
...
| ----- | ----- | ----- | -------------- |
| **Lexer** | token.rs, lexer.rs | 1703 | Source text to tokens, with line, column, and span tracking |
| **Parser** | ast.rs, parser.rs | 2235 | Recursive descent plus a Pratt expression parser |
| **Runtime model** | value.rs, ops.rs, builtins.rs, random.rs | 4919 | Values, operator and indexing rules, the builtin library |
| **Bytecode engine** | chunk.rs, globals.rs, compiler.rs, vm.rs | 4731 | Compiles the AST to bytecode, runs it on a stack VM, loads modules, and catches errors |
| **Diagnostics** | suggest.rs | 220 | Chooses the name an error offers back when a program misspells one |
| **Formatter** | formatter.rs | 876 | Reprints a program in canonical form (`miru fmt`) |
...
| **Total** | **20 files** | **18152** | Written from scratch in Rust |
