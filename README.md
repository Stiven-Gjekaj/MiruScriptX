...
| **Bytecode engine** | chunk.rs, globals.rs, compiler.rs, vm.rs | 4107 | Compiles the AST to bytecode, runs it on a stack VM, loads modules, and catches errors |
...
| **Total** | **16 files** | **11524** | Written from scratch in Rust |
