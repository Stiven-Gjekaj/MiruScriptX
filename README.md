...
| **Runtime model** | value.rs, ops.rs, builtins.rs | 2698 | Values, operator and indexing rules, the builtin library |
...
| **Total** | **15 files** | **10691** | Written from scratch in Rust |
