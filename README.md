...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-364_passing-427819?style=for-the-badge" alt="364 tests passing"/>
</p>
...
| **Runtime model** | value.rs, ops.rs, builtins.rs | 2997 | Values, operator and indexing rules, the builtin library |
| **Bytecode engine** | chunk.rs, globals.rs, compiler.rs, vm.rs | 4016 | Compiles the AST to bytecode, runs it on a stack VM, loads modules, and catches errors |
...
| **Library** | lib.rs | 729 | Ties it together (`parse_program`, `run_source`, `disassemble_source`) |
| **Total** | **15 files** | **11212** | Written from scratch in Rust |
