...
| **Runtime model** | value.rs, ops.rs, builtins.rs, random.rs | 4536 | Values, operator and indexing rules, the builtin library |
...
| **Total** | **19 files** | **15400** | Written from scratch in Rust |
