...
| **Bytecode engine** | chunk.rs, globals.rs, compiler.rs, vm.rs | 4116 | Compiles the AST to bytecode, runs it on a stack VM, loads modules, and catches errors |
...
| **Total** | **16 files** | **11533** | Written from scratch in Rust |
