...
| **Runtime model** | value.rs, ops.rs, builtins.rs, random.rs | 4420 | Values, operator and indexing rules, the builtin library |
...
| **Total** | **19 files** | **15274** | Written from scratch in Rust |
